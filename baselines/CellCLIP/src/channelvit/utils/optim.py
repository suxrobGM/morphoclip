...
[1] https://github.com/facebookresearch/barlowtwins/blob/main/main.py
[2] https://people.sc.fsu.edu/~jburkardt/presentations/truncated_normal.pdf
"""
...
def _no_grad_trunc_normal_(tensor, mean, std, a, b):
    ...
    with torch.no_grad():
        ...
        var_l = norm_cdf((a - mean) / std)
        u = norm_cdf((b - mean) / std)

        # Uniformly fill tensor with values from [l, u], then translate to
        # [2l-1, 2u-1].
        tensor.uniform_(2 * var_l - 1, 2 * u - 1)

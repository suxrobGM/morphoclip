"""Backbone of ChannelViT with Hierarchical Channel Sampling."""
...
class ChannelVisionTransformer(nn.Module):
    """
    Channel Vision Transformer w HCS. The only difference between
    ChannelVisionTransformer in channel_vit.py is enable_sample is set to True
    """

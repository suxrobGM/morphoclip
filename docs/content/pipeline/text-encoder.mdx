...
- **External TSVs** (recommended): `data/metadata/external_metadata/` — `JUMP-Target-1_compound_metadata_targets.tsv`, `JUMP-Target-1_crispr_metadata.tsv`, `JUMP-Target-1_orf_metadata.tsv`. Get via `uv run morphoclip data fetch --metadata`.

...
- These are produced from per-site feature tensors with `morphoclip cellclip export`
...
This is the heavier end-to-end path. If you already have per-site feature tensors, `morphoclip cellclip export` is the simpler entrypoint.

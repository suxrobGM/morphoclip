...
This page explains how the benchmark scores perturbation embeddings. It measures how well the embeddings capture biological similarity, using information retrieval metrics.
...
This is the hardest task: the embedding must capture functional similarity across two very different perturbation types.

...
Note: `scripts/benchmark/benchmark_stable.py` does not run this embedding branch; it analyzes profile feature columns directly.
...
- Use `scripts/benchmark/benchmark_stable.py` when you want:

...
**Results:** `data/benchmark_results/cellprofiler_matching_fr.csv`. Paper: ~5-25% of compounds and ~7-17% of CRISPR guides match their sister perturbations (per-target mAP in `cellprofiler_matching_map.csv`, 1,557 targets). This is the core limitation we address.
...
- **U2OS vs A549 differ:** Cell type context matters, which motivates including cell type in text prompts.
